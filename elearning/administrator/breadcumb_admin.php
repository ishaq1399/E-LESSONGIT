...
elseif($_GET['module']=='detailpengajar'){
        $pengajar = mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$_GET[id]'");
...
elseif($_GET['module']=='detailsiswa'){
        $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$_GET[id]'");
...
elseif($_GET['module']=='daftarsiswa'){
        $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_kelas = '$_GET[id]'");
        $s=mysqli_fetch_array($siswa);
