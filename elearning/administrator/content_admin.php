...
if ($_GET['module']=='home'){
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>, element.style.css di halaman Administrator eLesson Universitas Muhammadiyah Jember.<br>
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>,  element.style.css di halaman Administrator.<br>
          Silahkan klik menu pilihan yang berada di sebelah kiri untuk mengelola website.</p><br>";

          echo "<p align=right>Login : $hari_ini,
                <span id='date'></span>, <span id='clock'></span></p>";
          //detail pengajar
          $detail_pengajar=mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar='$_SESSION[idpengajar]'");
         ...
         $tampil_kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_pengajar = '$_SESSION[idpengajar]'");
         ...
         if (!empty($ketemu)){
                ...
                while ($r=mysqli_fetch_array($tampil_kelas)){
                    ...
                    $pengajar = mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$_SESSION[idpengajar]'");
                    ...
                    $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$r[id_siswa]'");
  ...
  $tampil_pelajaran = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_pengajar = '$_SESSION[idpengajar]'");
  ...
  if (!empty($cek_mapel)){
    ...
    while ($r=mysqli_fetch_array($tampil_pelajaran)){
       echo "<tr><td>$no</td>             
             ...
             $pengajar = mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$r[id_pengajar]'");
