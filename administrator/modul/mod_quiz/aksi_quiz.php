...
if ($module=='quiz' AND $act=='input_topikquiz'){
    $pelajaran = mysqli_query($db."SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$_POST[id_matapelajaran]'");
    $data = mysqli_fetch_array($pelajaran);
    $pengajar = mysqli_query($db."SELECT * FROM pengajar WHERE id_pengajar = '$data[id_pengajar]'");
    $cek_pengajar_pelajaran = mysqli_num_rows($pengajar);
    if (!empty($cek_pengajar_pelajaran)){
    
    $wpengerjaan = $_POST['waktu'] * 60;
    mysqli_query($db."INSERT INTO topik_quiz(
                                    judul,
                                    id_kelas,
                                    id_matapelajaran,
                                    tgl_buat,
...
elseif($module=='quiz' AND $act=='inputnilai'){
    mysqli_query($db."UPDATE siswa_sudah_mengerjakan SET dikoreksi = 'S'
                                                WHERE id_tq ='$_POST[id_tq]' AND id_siswa = '$_POST[id_siswa]'");
    mysqli_query($db."INSERT INTO nilai_soal_esay (id_tq,id_siswa,nilai)
...
elseif($module=='quiz' AND $act=='inputeditnilai'){
    mysqli_query($db."UPDATE nilai_soal_esay SET nilai = '$_POST[nilai]' WHERE id_tq ='$_POST[id_tq]' AND id_siswa = '$_POST[id_siswa]' ");
    header('location:../../media_admin.php?module=quiz&act=daftarsiswayangtelahmengerjakan&id='.$_POST[id_tq]);
}
...
elseif($module=='quiz' AND $act=='edit_topikquiz'){
    ...
    mysqli_query($db."UPDATE topik_quiz SET judul = '$_POST[judul]',
...
elseif($module=='quiz' AND $act=='editsiswayangtelahmengerjakan'){
    mysqli_query($db."DELETE FROM siswa_sudah_mengerjakan WHERE id_siswa='$_GET[id_siswa]' AND id = '$_GET[id]'");
    mysqli_query($db."DELETE FROM nilai_soal_esay WHERE id_tq='$_GET[id_tq]' AND id_siswa='$_GET[id_siswa]'");
    mysqli_query($db."DELETE FROM nilai WHERE id_tq='$_GET[id_tq]' AND id_siswa='$_GET[id_siswa]'");
    mysqli_query($db."DELETE FROM jawaban WHERE id_tq='$_GET[id_tq]' AND id_siswa ='$_GET[id_siswa]'");
    header('location:../../media_admin.php?module='.$module);
...
elseif($module=='quiz' AND $act=='hapustopikquiz'){
    //hapus topik
  mysqli_query($db."DELETE FROM topik_quiz WHERE id_tq = '$_GET[id]'");
  //hapus kuiz esay
  $cek = mysqli_query($db."SELECT * FROM quiz_esay WHERE id_tq = '$_GET[id]'");
     $r = mysqli_fetch_array($cek);
     if(empty($r[gambar])){
        mysqli_query($db."DELETE FROM quiz_esay WHERE id_tq = '$_GET[id]'");
     }else{
  ...
  $cek2 = mysqli_query($db."SELECT * FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
     $r2 = mysqli_fetch_array($cek2);
     if(empty($r2[gambar])){
        mysqli_query($db."DELETE FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
     }else{
        ...
        if (file_exists($direktori_file)){
            ...
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"             
                ...
                mysqli_query($db."INSERT INTO quiz_esay(id_tq,pertanyaan,gambar,tgl_buat)
                   VALUES('$_POST[id]','$_POST[pertanyaan]','$nama_file','$tgl_sekarang')");
            }
        }     
    }else{
        mysqli_query($db."INSERT INTO quiz_esay(id_tq,pertanyaan,tgl_buat)
      ...
      if (file_exists($direktori_file)){
            ...
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"
                ...
                mysqli_query($db."INSERT INTO quiz_pilganda(id_tq,pertanyaan,gambar,pil_a,pil_b,pil_c,pil_d,kunci,tgl_buat)
                   VALUES('$_POST[id]','$_POST[pertanyaan]','$nama_file','$_POST[pila]','$_POST[pilb]','$_POST[pilc]','$_POST[pild]','$_POST[kunci]','$tgl_sekarang')");
            }
        }
    }else{
        mysqli_query($db."INSERT INTO quiz_pilganda(id_tq,pertanyaan,pil_a,pil_b,pil_c,pil_d,kunci,tgl_buat)
        ...
        if (file_exists($direktori_file)){
            ...
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"               
                ...
                $cek = mysqli_query($db."SELECT * FROM quiz_esay WHERE id_quiz = '$_POST[id]'");
                $r = mysqli_fetch_array($cek);
                if(!empty($r[gambar])){
                $img = "../../../foto_soal/$r[gambar]";
                unlink($img);
                ...
                unlink($img2);
                UploadImage_soal($nama_file);
                mysqli_query($db."UPDATE quiz_esay SET pertanyaan = '$_POST[pertanyaan]',
                                                  gambar     = '$nama_file',
                                                  tgl_buat   = '$tgl_sekarang'
...
elseif($module=='quiz' AND $act=='hapusquizesay'){
     $cek = mysqli_query($db."SELECT * FROM quiz_esay WHERE id_quiz = '$_GET[id]'");
     $r = mysqli_fetch_array($cek);
     if(empty($r[gambar])){
        mysqli_query($db."DELETE FROM quiz_esay WHERE id_quiz = '$_GET[id]'");
     }else{
         $img = "../../../foto_soal/$r[gambar]";
         unlink($img);
         $img2 = "../../../foto_soal/medium_$r[gambar]";
      ...
      if (file_exists($direktori_file)){
            ...
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"
                ...
                $cek = mysqli_query($db."SELECT * FROM quiz_pilganda WHERE id_quiz = '$_POST[id]'");
                $r = mysqli_fetch_array($cek);
                if(!empty($r[gambar])){
                ...
                unlink($img2);
                UploadImage_soal_pilganda($nama_file);
                mysqli_query($db."UPDATE quiz_pilganda SET pertanyaan = '$_POST[pertanyaan]',
                                           gambar     = '$nama_file',
                                           pil_a      = '$_POST[pila]',
                                           pil_b      = '$_POST[pilb]',
                                           pil_c      = '$_POST[pilc]',
...
elseif($module=='quiz' AND $act=='hapusquizpilganda'){
    $cek = mysqli_query($db."SELECT * FROM quiz_pilganda WHERE id_quiz = '$_GET[id]'");
     $r = mysqli_fetch_array($cek);
     if(empty($r[gambar])){
        mysqli_query($db."DELETE FROM quiz_pilganda WHERE id_quiz = '$_GET[id]'");
     }else{
         $img = "../../../foto_soal_pilganda/$r[gambar]";
         unlink($img);
         $img2 = "../../../foto_soal_pilganda/medium_$r[gambar]";
