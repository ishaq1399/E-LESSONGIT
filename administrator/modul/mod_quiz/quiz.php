...
switch($_GET[act]){
  ...
  default:
      ...
      if ($_SESSION[leveluser]=='admin'){    
        ...
        $tampil_topik = mysqli_query($db,"SELECT * FROM topik_quiz ORDER BY id_kelas");
    ...
    while ($r=mysqli_fetch_array($tampil_topik)){
      ...
      $tgl_buat   = tgl_indo($r[tgl_buat]);
       echo "<tr><td>$no</td>
             <td>$r[judul]</td>";
             $kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$r[id_kelas]'");
             ...
             $pelajaran = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$r[id_matapelajaran]'");
             ...
             echo"<td>$tgl_buat</td>";
             $pelajaran2 = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$r[id_matapelajaran]'");
             $p2=mysqli_fetch_array($pelajaran2);
             $pembuat = mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$p2[id_pengajar]'");
    ...
    $tampil_topik = mysqli_query($db,"SELECT * FROM topik_quiz WHERE pembuat = '$_SESSION[idpengajar]'");
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$_SESSION[idsiswa]'");
        $data_siswa = mysqli_fetch_array($siswa);
        $mapel = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_kelas = '$data_siswa[id_kelas]'");
...
case "daftarsiswayangtelahmengerjakan":
    if ($_SESSION[leveluser]=='admin'){
        $siswa_yangmengerjakan = mysqli_query($db,"SELECT * FROM siswa_sudah_mengerjakan WHERE id_tq = '$_GET[id]'");
        ...
        $siswa_yangmengerjakan2 = mysqli_query($db,"SELECT * FROM siswa_sudah_mengerjakan WHERE id_tq = '$_GET[id]'");
        ...
        while ($t=mysqli_fetch_array($siswa_yangmengerjakan2)){
            $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$t[id_siswa]'");
            $s = mysqli_fetch_array($siswa);
            $kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$s[id_kelas]'");
            $k = mysqli_fetch_array($kelas);
            $nilai = mysqli_query($db,"SELECT * FROM nilai_soal_esay WHERE id_tq='$_GET[id]' AND id_siswa ='$t[id_siswa]'");
            $n = mysqli_fetch_array($nilai);
            $nilai2 = mysqli_query($db,"SELECT * FROM nilai WHERE id_tq='$_GET[id]' AND id_siswa = '$t[id_siswa]'");
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        $siswa_yangmengerjakan = mysqli_query($db,"SELECT id_siswa FROM siswa_sudah_mengerjakan WHERE id_tq = '$_GET[id]'");
        $cek_siswa = mysqli_num_rows($siswa_yangmengerjakan);
        ...
        $soal_esay = mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_tq='$_GET[id]'");
...
case "koreksi":
    if ($_SESSION[leveluser]=='admin'){
        ...
        $esay = mysqli_num_rows($soal_esay);
        if (!empty($pilganda) AND !empty($esay)){
            $siswa = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa='$_GET[id_siswa]'");
            $s = mysqli_fetch_array($siswa);
            $jawaban = mysqli_query($db,"SELECT * FROM jawaban WHERE id_tq='$_GET[id]' AND id_siswa='$_GET[id_siswa]'");
            $cek=mysqli_num_rows($jawaban);
            if (!empty($cek)){
                echo "<h2>Jawaban Soal Essay Siswa <b>$s[nama_lengkap]</b></h2><hr>";
                $no=1;
                while ($j=mysqli_fetch_array($jawaban)){
                    $soal_esay2 = mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_tq='$j[id_tq]' AND id_quiz='$j[id_quiz]'");
...
case "tambahtopikquiz":
    ...
    <dt><label>Kelas</label></dt>               <dd> <select name='id_kelas' onChange='showpel_pengajar()'>
                                          <option value=''>-pilih-</option>";
                                          $pilih= mysqli_query($db,"SELECT DISTINCT id_kelas FROM mata_pelajaran WHERE id_pengajar ='$_SESSION[idpengajar]'");
                                          while($row=mysqli_fetch_array($pilih)){
                                          $cari_kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$row[id_kelas]'");
...
case "edittopikquiz":
    ...
    $edit=mysqli_query($db,"SELECT * FROM topik_quiz WHERE id_tq = '$_GET[id]'");
    $t=mysqli_fetch_array($edit);
    $isikelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$t[id_kelas]'");
    $k=mysqli_fetch_array($isikelas);
    $pelajaran = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$t[id_matapelajaran]'");
    $p=mysqli_fetch_array($pelajaran);
...
case "daftartopik":
    if ($_SESSION[leveluser]=='siswa'){
        $mapel = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$_GET[id]'");
        $data_mapel = mysqli_fetch_array($mapel);
        $topik = mysqli_query($db,"SELECT * FROM topik_quiz WHERE id_kelas = '$_GET[id_kelas]' AND id_matapelajaran = '$_GET[id]' AND terbit='Y'");
        ...
        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar Tugas / Quiz Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p>
              ...
              while($t=mysqli_fetch_array($topik)){
                  ...
                  $pengajar =  mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$t[pembuat]'");
...
case "nilaisiswa":
    if ($_SESSION[leveluser]=='siswa'){
        $quiz_pilganda = mysqli_query($db,"SELECT * FROM quiz_pilganda WHERE id_tq = '$_GET[id_topik]'");
        $quiz_esay = mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_tq = '$_GET[id_topik]'");
        $c_pilganda = mysqli_num_rows($quiz_pilganda);
        $c_esay = mysqli_num_rows($quiz_esay);

        if (!empty($c_pilganda) AND !empty($c_esay)){
        $pilganda = mysqli_query($db,"SELECT * FROM nilai WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
        $cek_pilganda = mysqli_num_rows($pilganda);
        $esay = mysqli_query($db,"SELECT * FROM nilai_soal_esay WHERE id_tq = '$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
        ...
        $cek_esay = mysqli_num_rows($esay);
                ...
                elseif (empty($cek_esay)) {
                    $kerjakan = mysqli_query($db,"SELECT * FROM siswa_sudah_mengerjakan WHERE id_tq='$_GET[id_topik]' AND id_siswa = '$_SESSION[idsiswa]'");
...
case "infokerjakan":
    if ($_SESSION[leveluser]=='siswa'){
        $cek = mysqli_query($db,"SELECT * FROM siswa_sudah_mengerjakan WHERE id_tq='$_GET[id]' AND id_siswa = '$_SESSION[idsiswa]'");
        $data = mysqli_fetch_array($cek);
        
        if ($data[hits]<=0){
        $topik = mysqli_query($db,"SELECT * FROM topik_quiz WHERE id_tq = '$_GET[id]'");
...
case "buatquizesay":
    if ($_SESSION[leveluser]=='admin'){
        $jum = mysqli_query($db,"SELECT COUNT(quiz_esay.id_quiz) as jml FROM quiz_esay WHERE id_tq = '$_GET[id]'");
...
case "buatquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        $jum = mysqli_query($db,"SELECT COUNT(quiz_pilganda.id_quiz) as jml FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
        $j = mysqli_fetch_array($jum);
        $jumlah = $j[jml] + 1;
...
case "daftarquizesay":
    if ($_SESSION[leveluser]=='admin'){
        $cek = mysqli_query($db,"SELECT COUNT(quiz_esay.id_quiz) as jml FROM quiz_esay WHERE id_tq = '$_GET[id]'");
        $c = mysqli_fetch_array($cek);
        if ($c[jml] != 0){
        $quiz=mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_tq = '$_GET[id]'");        
        $jquiz = mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_tq = '$_GET[id]'");
        $jq = mysqli_fetch_array($jquiz);
        $topik = mysqli_query($db,"SELECT * FROM topik_quiz WHERE id_tq = '$jq[id_tq]'");
        $t=mysqli_fetch_array($topik);
        $kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$t[id_kelas]'");
        $k=mysqli_fetch_array($kelas);
        $pelajaran = mysqli_query($db,"SELECT * FROM mata_pelajaran WHERE id_matapelajaran = '$t[id_matapelajaran]'");
        $p = mysqli_fetch_array($pelajaran);
...
case "daftarquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        $cek = mysqli_query($db,"SELECT COUNT(quiz_pilganda.id_quiz) as jml FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
        $c = mysqli_fetch_array($cek);
        if ($c[jml] != 0){
        $quiz=mysqli_query($db,"SELECT * FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
        $jquiz = mysqli_query($db,"SELECT * FROM quiz_pilganda WHERE id_tq = '$_GET[id]'");
        $jq = mysqli_fetch_array($jquiz);
        $topik = mysqli_query($db,"SELECT * FROM topik_quiz WHERE id_tq = '$jq[id_tq]'");
        $t=mysqli_fetch_array($topik);
        $kelas = mysqli_query($db,"SELECT * FROM kelas WHERE id_kelas = '$t[id_kelas]'");
...
case "editquizesay":
    if ($_SESSION[leveluser]=='admin'){
        $quiz=mysqli_query($db,"SELECT * FROM quiz_esay WHERE id_quiz = '$_GET[id]'");
...
case "editquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        $quiz=mysqli_query($db,"SELECT * FROM quiz_pilganda WHERE id_quiz = '$_GET[id]'");
        $q = mysqli_fetch_array($quiz);
