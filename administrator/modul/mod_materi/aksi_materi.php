...
if ($module=='materi' AND $act=='input_materi'){
  ...
  $pengajar = mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar = '$data_mapel[id_pengajar]'");
  ...
  if (!empty($lokasi_file)){
      ...
      elseif (!in_array($ekstensi, $extensionList)){
                ...
                window.location=('../../media_admin.php?module=materi&act=tambahmateri')</script>";
                    ...
                    mysqli_query($db,"INSERT INTO file_materi(judul,
                                    id_kelas,
                                    id_matapelajaran,
                                    nama_file,
                                    tgl_posting,
    ...
    if (file_exists($direktori_file)){
            ...
            window.location=(href='../../media_admin.php?module=materi')</script>";}
                ...
                if(!in_array($ekstensi, $extensionList)){
                    ...
                    $cek = mysqli_query($db,"SELECT * FROM file_materi WHERE id_file = '$_POST[id]'");
                    ...
                    UploadFile($nama_file);
                    mysqli_query($db,"UPDATE file_materi SET judul = '$_POST[judul]',
...
elseif($module=='materi' AND $act=='hapus'){
  $cek = mysqli_query($db,"SELECT * FROM file_materi WHERE id_file = '$_GET[id]'");
                    $r = mysqli_fetch_array($cek);
                    if(!empty($r[nama_file])){
                    $file = "../../../files_materi/$r[nama_file]";
                    unlink($file);
                    
                    mysqli_query($db,"DELETE FROM file_materi WHERE id_file = '$_GET[id]'");
                    }
                    else{
                        mysqli_query($db,"DELETE FROM file_materi WHERE id_file = '$_GET[id]'");
                    }
