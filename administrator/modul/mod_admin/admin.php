...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      $tampil_admin = mysqli_query($db,"SELECT * FROM admin ORDER BY username");      
  ...
  case "pengajar":
  if ($_SESSION[leveluser]=='admin'){
      $tampil_pengajar = mysqli_query($db,"SELECT * FROM pengajar");
  ...
  case "editadmin":
    $edit=mysqli_query($db,"SELECT * FROM admin WHERE id_session='$_GET[id]'");
 ...
 case "editpengajar":
    $edit=mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar='$_GET[id]'");
    $r=mysqli_fetch_array($edit);
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        $edit=mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar='$_SESSION[idpengajar]'");
        $r=mysqli_fetch_array($edit);
...
case "detailpengajar":
    $detail=mysqli_query($db,"SELECT * FROM pengajar WHERE id_pengajar='$_GET[id]'");
