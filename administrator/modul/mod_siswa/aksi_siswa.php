...
if ($module=='siswa' AND $act=='input_siswa'){
  ...
  $cek_nis = mysqli_query($db,"SELECT * FROM siswa WHERE nis='$_POST[nis]'");
 ...
 elseif ($module=='siswa' AND $act=='update_siswa'){
  ...
  $cek_nis = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$_POST[id]'");
  ...
  elseif(!empty($lokasi_file) AND empty($_POST[password])){
      if (file_exists($direktori_file)){
            ...
            $cek = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$_POST[id]'");
...
elseif ($module=='siswa' AND $act=='update_account_siswa'){
    ...
    elseif (!empty($_POST[username]) AND empty($_POST[password])){
        $username = mysqli_query($db,"SELECT * FROM siswa WHERE id_siswa = '$_SESSION[idsiswa]'");
        ...
        elseif ($_POST[username] != $data_username[username_login]){
            $username2 = mysqli_query($db,"SELECT * FROM siswa WHERE username_login = '$_POST[username]'");
    ...
    elseif (!empty($_POST[username]) AND !empty($_POST[password])){
        $username = mysqli_query($db,"SELECT * FROM siswa WHERE username_login = '$_POST[username]'");
        $data_username = mysqli_fetch_array($username);
